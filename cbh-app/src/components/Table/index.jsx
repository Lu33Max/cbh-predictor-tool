...
const Table = ({ data, rowsPerPage }) => {
  ...
  return (
    <>
        {(window.$activeTable === 'Bing' || window.$activeTable === 'Google') && renderSearchTermTable(slice)}
        {(window.$activeTable === 'Lead') && renderLeadTable(slice)}
        {(window.$activeTable === 'Order') && renderOrderTable(slice)}
    </>
  );
